...
console.log(author, title, genres); // Stanislaw Lem The Cyberiad

// const primaryGenre = genres[0]; 
// const secondaryGenre = genres[1]; 

const [primaryGenre, secondaryGenre, ...otherGenres] = genres; // Destructuring and ... rest operator

console.log(primaryGenre, secondaryGenre, otherGenres);

const newGenres = ['epic fantasy', ...genres]; //spread operator
newGenres;
